...
@section('content')
    ...
    <header id="header">
        <div class="container">
            <div class="row align-items-center justify-content-between d-flex">
                <div id="logo">
                    <a href="index.html"><img src="{{ asset('storage/images/logo.png') }}" alt="" title="" /></a>
                </div>
    ...
    <section class="home-banner-area relative">
        ...
        <div class="rocket-img">
            <img src="{{ asset('storage/images/rocket.png') }}" alt="">
        </div>
    </section>
    <!-- End Banner Area -->
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-5 col-md-6 about-left">
                    <img class="img-fluid" src="{{ asset('storage/images/about.jpg') }}" alt="">
                </div>
            ...
            <div class="row justify-content-center d-flex align-items-center">
                <div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
                    <div class="thumb d-flex justify-content-center">
                        <img class="img-fluid" src="{{ asset('storage/images/faculty/f1.jpg') }}" alt="">
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
                    <div class="thumb d-flex justify-content-center">
                        <img class="img-fluid" src="{{ asset('storage/images/faculty/f2.jpg') }}" alt="">
                    </div>
                    <div class="meta-text text-center">
                        <h4>Rodney Cooper</h4>
                        <p class="designation">Sr. Faculty Data Science</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
                    <div class="thumb d-flex justify-content-center">
                        <img class="img-fluid" src="{{ asset('storage/images/faculty/f3.jpg') }}" alt="">
                    </div>
                    <div class="meta-text text-center">
                        <h4>Dora Walker</h4>
                        <p class="designation">Sr. Faculty Data Science</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
                    <div class="thumb d-flex justify-content-center">
                        <img class="img-fluid" src="{{ asset('storage/images/faculty/f4.jpg') }}" alt="">
                    </div>
                    <div class="meta-text text-center">
                        <h4>Lena Keller</h4>
                        <p class="designation">Sr. Faculty Data Science</p>
        ...
        <div class="container">
            ...
            <div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
                <div class="owl-thumb-item">
                    <div>
                        <img class="img-fluid" src="{{ asset('storage/images/testimonial/t1.jpg') }}">
                    </div>
                    <div class="overlay overlay-grad"></div>
                </div>
                <div class="owl-thumb-item">
                    <div>
                        <img class="img-fluid" src="{{ asset('storage/images/testimonial/t2.jpg') }}">
                    </div>
                    <div class="overlay overlay-grad"></div>
                </div>
                <div class="owl-thumb-item">
                    <div>
                        <img class="img-fluid" src="{{ asset('storage/images/testimonial/t3.jpg') }}">
                    </div>
                    <div class="overlay overlay-grad"></div>
                </div>
                <div class="owl-thumb-item">
                    <div>
                        <img class="img-fluid" src="{{ asset('storage/images/testimonial/t4.jpg') }}">
                    </div>
                    <div class="overlay overlay-grad"></div>
                </div>
            </div>
    ...
    <!-- JAVASCRIPT LINKS -->
    <script src="{{ asset('js/educature/vendor/jquery-2.2.4.min.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q"
    crossorigin="anonymous"></script>
    <script src="{{ asset('js/educature/vendor/bootstrap.min.js') }}"></script>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
    <script src="{{ asset('js/educature/easing.min.js') }}"></script>
    <script src="{{ asset('js/educature/hoverIntent.js') }}"></script>
    <script src="{{ asset('js/educature/superfish.min.js') }}"></script>
    <script src="{{ asset('js/educature/jquery.ajaxchimp.min.js') }}"></script>
    <script src="{{ asset('js/educature/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('js/educature/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('js/educature/owl-carousel-thumb.min.js') }}"></script>
    <script src="{{ asset('js/educature/jquery.sticky.js') }}"></script>
    <script src="{{ asset('js/educature/jquery.nice-select.min.js') }}"></script>
    <script src="{{ asset('js/educature/parallax.min.js') }}"></script>
    <script src="{{ asset('js/educature/waypoints.min.js') }}"></script>
    <script src="{{ asset('js/educature/wow.min.js') }}"></script>
    <script src="{{ asset('js/educature/jquery.counterup.min.js') }}"></script>
    <script src="{{ asset('js/educature/mail-script.js') }}"></script>
    <script src="{{ asset('js/educature/main.js') }}"></script>
@endsection